...
Use `--index <directory>` to select an existing enhanced retrieval package. The default is the most recent package in `artifacts/03_retrieval_enhanced/`. Run the retrieval notebook first if none exists.
