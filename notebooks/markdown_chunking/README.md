...
uv run python notebooks/markdown_chunking/run_step.py
```

Outputs go to a new directory under `artifacts/step-05/`. This step performs no retrieval indexing, embeddings, or model calls.
