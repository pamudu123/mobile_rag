...
| [03_2 Hybrid sanity](retrieval/03_2_hybrid_sanity.ipynb) | Check independent BM25/BGE switches, inspect evidence, and compare Q_S1 retrieval without generation API calls. |
